    ...
    async request(dir){
        const response = await fetch(`${this.baseURL}${dir}`, {
            headers: {
                ...
                "Cookie": "geo=152.59.147.226%2CIN%2CBihar%2CPatna%2C800001; mm_latlong=25.5943%2C85.1352; CH=G03%2CA07%2CO00%2CL03; _pl=web6dot0-; DL=english; B=5e732d3ddc3c25e7a8364c5c59c072b1; CT=NjgxODI4NDE0; L=hindi"
            }
        });
